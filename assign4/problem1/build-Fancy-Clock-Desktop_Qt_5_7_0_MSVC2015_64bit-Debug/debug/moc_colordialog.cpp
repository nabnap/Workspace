...
#include "../../Fancy-Clock/colordialog.h"
...
QT_MOC_LITERAL(1, 12, 11), // "colorSelect"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 9) // "saveColor"

    },
    "ColorDialog\0colorSelect\0\0saveColor"
};
...
void ColorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->colorSelect(); break;
        case 1: _t->saveColor(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *ColorDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::ColorPick"))
        return static_cast< Ui::ColorPick*>(const_cast< ColorDialog*>(this));
