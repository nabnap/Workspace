...
void CSketcherDoc::OnUpdateColorBlack(CCmdUI *pCmdUI)
{
	...
	pCmdUI->SetText(m_Color == ElementColor::BLACK ? L"BLACK" : L"black");
}
...
void CSketcherDoc::OnUpdateColorRed(CCmdUI *pCmdUI)
{
	...
	pCmdUI->SetText(m_Color == ElementColor::RED ? L"RED" : L"red");
}
...
void CSketcherDoc::OnUpdateColorGreen(CCmdUI *pCmdUI)
{
	...
	pCmdUI->SetText(m_Color == ElementColor::GREEN ? L"GREEN" : L"green");
}
...
void CSketcherDoc::OnUpdateColorBlue(CCmdUI *pCmdUI)
{
	...
	pCmdUI->SetText(m_Color == ElementColor::BLUE ? L"BLUE" : L"blue");
}
